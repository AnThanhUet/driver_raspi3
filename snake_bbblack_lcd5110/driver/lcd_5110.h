...
#define setYAddressBank2		0x41
#define setYAddressBank3		0x42
#define setYAddressBank4		0x43
#define setYAddressBank5		0x44
#define setYAddressBank6		0x45
...
unsigned char LCD_DrawPixel(unsigned char x, unsigned char y, LCD_Pixel_t pixel);
